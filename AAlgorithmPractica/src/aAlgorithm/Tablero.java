...
public class Tablero {
    ...
    public String toString() {
        ...
        if(!getPathFound()) {
            sb.append("With this initial board is absolutely impossible to find a path between I and G thorugh the obstacles");
        }
        return sb.toString();
    }
    ...
    protected int algorithm() {
        ...
        Map<Point, Double> f = new HashMap<Point, Double>();
        ...
        g.put(inicial, 0.0);
        f.put(inicial, (double) h(inicial));
        pq.add(inicial);
        ...
        while(!pq.isEmpty()) {
            ...
            for (Point sucesor : actual.getNeighbors(this.tab, this.fila, this.columna)) {
                ...
                if (!g.containsKey(sucesor) || gScore < g.get(sucesor)) {
                    ...
                    int h = h(sucesor);
                    f.put(sucesor, gScore + h(sucesor));
